    ...
    <div className='container'>
      ...
      <form  className={styles.contactForm} action="https://formsubmit.co/thureinwin.dev@gmail.com" method="POST">
            ...
            <div className={styles.socialIconsContainer}>
                ...
                <a className={styles.socialLink} href='https://www.linkedin.com/in/thurein-win-0bb31523a' target="_blank" rel='noreferrer'><Icon icon="entypo-social:linkedin-with-circle" className='social-icon' /></a>
            </div>
        </form>
